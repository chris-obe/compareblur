export const UI_TOOLTIPS = {
  ...
  compareChartReadout: 'Choose what the cursor shows when you hover across a background position on the graph.',
  compareReadoutFixed: 'Shows one ranked blur list for all systems at the cursor position.',
  compareReadoutTracked: 'Pins blur labels beside selected lines as the cursor moves.',
